...
$proc = Start-Process docker -ArgumentList 'compose run test_env pwsh -command ./BUILD/test/test.ps1' -WorkingDirectory './BUILD/test' -Wait -NoNewWindow:$noNewWindow -PassThru;
